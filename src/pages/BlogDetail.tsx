...
import { ArrowRight, Check, ChevronLeft, Clock, Share2 } from "lucide-react";
...
"item": window.location.href
 ...
 className="group flex items-center gap-2.5 px-4 md:px-5 py-2 rounded-full bg-black/40 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all active:scale-90"
 >
 ...
 <section className="relative h-[75vh] sm:h-[85vh] md:h-screen flex items-center justify-center overflow-hidden bg-[#020202]">
 <motion.div 
 style={{ y: heroY, opacity: heroOpacity, scale: heroScale }}
 className="absolute inset-0 z-0"
 >
 <div className="absolute inset-0 bg-gradient-to-b from-[#020202]/80 via-transparent to-[#020202] z-10" />
 ...
 >
 <div className="inline-flex items-center gap-4 px-4 md:px-5 py-1.5 rounded-full bg-primary/5 border border-primary/10">
 ...
 <div className="p-10 rounded-[40px] bg-white/[0.01] border border-white/5 space-y-12 relative overflow-hidden group">
 ...
 {/* Main Content Area */}
 <div className="lg:col-span-8 lg:col-start-4 space-y-16 md:space-y-40">
...
"Luxury is no longer just about what you see... it's about the <span className="text-primary italic font-light lowercase">air you breathe</span>."
 ...
 className="flex items-center gap-3 px-6 py-3.5 rounded-full bg-black/60 border border-white/10 shadow-2xl active:scale-95 transition-all"
 >
 {isCopied ? (
